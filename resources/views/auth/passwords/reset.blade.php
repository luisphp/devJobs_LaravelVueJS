        ...
        <div class="w-full max-w-sm">
            <div class="flex flex-col break-words bg-white border boder-2 shadow-md mt-20">
                ...
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    ...
                    method="POST" action="{{ route('password.update') }}" novalidate>
                        @csrf
                        ...
                        <div class="flex flex-wrap mb-6">
                            <label for="block text-gray-700 text-sm mb-2">{{ __('Confirm Password') }}</label>
                        ...
                        <div class="flex flex-wrap">
                            <div class="col-md-6 offset-md-4">
                                <button type="submit" class="bg-gray-500 w-full hover:bg-gray-700 text-gray-100 p-3 focus:outline-none focus:shadow-outline uppercase">
                                    {{ __('Reset Password') }}
                                </button>
                            </div>
                        </div>
